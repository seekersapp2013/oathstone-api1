...
async function deployEtnContract(req, res) {
    try {
        ...
        // Connect to Electroneum network using Infura
        ...
        res.status(200).json({
            message: "Electroneum contract deployed successfully!",
            contractTitle,          // Include the contract title in the response
            environment,            // Environment passed to the API (0 or 1)
            network: "Electroneum",                // Always set to "celo"
            userBalance: balanceInEther,
            gasFee: estimatedGasFeeInEther,
            transactionFee: transactionFeeInEther,
        ...
        console.error("Error deploying Electroneum contract:", error);

        // Create a user-friendly error response
        const userErrorResponse = {
            error: "Failed to deploy Electroneum contract.",
